...
msbuild.exe $PSScriptRoot\MSBuild\$project.proj /t:Build /p:"AllowUnsafeBlocks=false;Configuration=Release" /p:SolutionDirectory=$solutionDir /verbosity:m | Error-Coloring  -Verbose:$Verbose -Trace:$Trace
